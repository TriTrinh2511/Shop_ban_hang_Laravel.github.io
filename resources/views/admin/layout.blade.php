                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown d-inline-block ml-2">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user" src="{{asset('manager/assets/images/users/avatar-3.jpg')}}" >
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-right d-none td-sm-block">
                                Design & Develop by Hung,Tri,Tuong
                            </div>
                        </div>
                    </div>
                </div>
