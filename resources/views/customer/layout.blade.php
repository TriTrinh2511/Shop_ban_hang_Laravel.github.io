                        ...
                        <div class="align-self-center">
                            <div class="header-search">
                                <div class="ec-btn-group-form" action="#">
                                    <input class="form-control product-search-field" placeholder="Nhập tên sản phẩm..." type="text">
                            ...
                            <div class="ec-footer-widget">
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link">Hùng , Trí , Tường</li>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col text-center footer-copy">
                            <div class="footer-bottom-copy ">
                                <div class="ec-copy">Nhóm 3 con sâu <a class="site-name text-upper"
                                        href="#"> : <span>.</span></a> "Death is like the wind always by my side"</div>
                            </div>
                        </div>
